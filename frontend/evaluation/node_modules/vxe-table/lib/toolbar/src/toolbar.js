...
var _default2 = {
  ...
  render: function render(h) {
    ...
    return h('div', {
      ...
      class: importOpts.icon || _conf.default.icon.TOOLBAR_TOOLS_IMPORT
      ...
      class: exportOpts.icon || _conf.default.icon.TOOLBAR_TOOLS_EXPORT
    })]) : null, refresh ? h('div', {
      ...
      class: this.isRefresh ? refreshOpts.iconLoading || _conf.default.icon.TOOLBAR_TOOLS_REFRESH_LOADING : refreshOpts.icon || _conf.default.icon.TOOLBAR_TOOLS_REFRESH
      ...
      class: $xegrid.isMaximized() ? zoomOpts.iconOut || _conf.default.icon.TOOLBAR_TOOLS_ZOOM_OUT : zoomOpts.iconIn || _conf.default.icon.TOOLBAR_TOOLS_ZOOM_IN
      ...
      class: customOpts.icon || _conf.default.icon.TOOLBAR_TOOLS_CUSTOM
    })]), h('div', {
