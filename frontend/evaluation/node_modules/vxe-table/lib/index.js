...
var Methods = {
  ...
  loadTableData: function loadTableData(datas) {
    ...
    var scrollYLoad = !treeConfig && sYOpts && sYOpts.gt && sYOpts.gt < tableFullData.length;
  ...
  refreshColumn: function refreshColumn() {
    ...
    var scrollXLoad = sXOpts && sXOpts.gt && sXOpts.gt < tableFullColumn.length;
  ...
  triggerCellClickEvent: function triggerCellClickEvent(evnt, params) {
    ...
    var triggerTreeNode = column.treeNode && DomTools.getEventTargetNode(evnt, $el, 'vxe-tree--btn-wrapper').flag; // 如果点击了树节点

    if (!triggerTreeNode) {
      var triggerExpandNode = column.type === 'expand' && DomTools.getEventTargetNode(evnt, $el, 'vxe-table--expanded').flag;
...
/* harmony default export */ var table = ({
  ...
  computed: {
    ...
    customOpts: function customOpts() {
      return Object.assign({}, conf.table.customConfig, this.customConfig === true ? {
        storage: true
      } : this.customConfig);
    },
...
/* harmony default export */ var footer = ({
  ...
  render: function render(h) {
    ...
    var tableListeners = $xetable.$listeners,
        ...
        currentColumn = $xetable.currentColumn,
        overflowX = $xetable.overflowX,
        scrollbarWidth = $xetable.scrollbarWidth; // 如果是使用优化模式
  ...
  computed: {
    ...
    stepValue: function stepValue() {
      ...
      if (type === 'integer') {
        ...
        return xe_utils_amd_xe_utils_default.a.toNumber(step || '0.' + '1'.padStart(this.digits, '0'));
      }
  ...
  methods: {
    ...
    scrollTo: function scrollTo(scrollLeft, scrollTop) {
      ...
      if (this.scrollYLoad) {
        return new Promise(function (resolve) {
          return setTimeout(function () {
            return resolve(_this3.$nextTick());
          }, 50);
        });
      }
    ...
    computeScrollLoad: function computeScrollLoad() {
      ...
      return this.$nextTick().then(function () {
        var $refs = _this4.$refs,
            sYOpts = _this4.sYOpts,
            scrollYLoad = _this4.scrollYLoad,
            scrollYStore = _this4.scrollYStore;
...
var components = [// 模块
packages_column, packages_header, packages_footer, filter, packages_loading, packages_grid, packages_menu, packages_toolbar, packages_pager, packages_checkbox, packages_radio, packages_input, packages_textarea, packages_button, packages_modal, packages_tooltip, packages_form, packages_select, packages_switch, packages_list, edit, packages_export, keyboard, validator, packages_resize, // 核心
packages_table]; // 默认安装
