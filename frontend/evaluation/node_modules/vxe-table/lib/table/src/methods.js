...
var Methods = {
  ...
  handleGlobalMousedownEvent: function handleGlobalMousedownEvent(evnt) {
    ...
    if (filterWrapper) {
      if (_tools.DomTools.getEventTargetNode(evnt, $el, 'vxe-cell--filter').flag) {// 如果点击了筛选按钮
        ...
        if (!_tools.DomTools.getEventTargetNode(evnt, document.body, 'vxe-dropdown--panel').flag) {
  ...
  clearCheckboxRow: function clearCheckboxRow() {
    ...
    if (reserve) {
      tableFullData.forEach(function (row) {
        var rowid = _tools.UtilTools.getRowid(_this27, row);
  ...
  triggerCellClickEvent: function triggerCellClickEvent(evnt, params) {
    ...
    var triggerTreeNode = column.treeNode && _tools.DomTools.getEventTargetNode(evnt, $el, 'vxe-tree--btn-wrapper').flag; // 如果点击了树节点


    if (!triggerTreeNode) {
      var triggerExpandNode = column.type === 'expand' && _tools.DomTools.getEventTargetNode(evnt, $el, 'vxe-table--expanded').flag;
    ...
    _tools.UtilTools.emitEvent(this, 'cell-click', [Object.assign({
      $event: evnt
    }, params), evnt]);
  },
  ...
  triggerCellDBLClickEvent: function triggerCellDBLClickEvent(evnt, params) {
    ...
    _tools.UtilTools.emitEvent(this, 'cell-dblclick', [Object.assign({
      $event: evnt
    }, params), evnt]);
  },
  ...
  handleAsyncRowExpand: function handleAsyncRowExpand(row) {
    ...
    return new Promise(function (resolve) {
      ...
      _this31.expandOpts.loadMethod({
        ...
        _xeUtils.default.remove(_this31.expandLazyLoadeds, function (item) {
          return item === row;
        });
