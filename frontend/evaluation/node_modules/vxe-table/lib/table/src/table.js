...
var _default2 = {
  ...
  computed: {
    ...
    customOpts: function customOpts() {
      return Object.assign({}, _conf.default.table.customConfig, this.customConfig === true ? {
        storage: true
      } : this.customConfig);
    },
  ...
  created: function created() {
    ...
    if (mouseConfig && this.editConfig) {
      ...
      if (mouseOpts.selected && editOpts.mode !== 'cell') {
        _tools.UtilTools.error('vxe.error.errProp', ['edit-config.mode', 'cell']);
      }
    }

    if (treeConfig && this.stripe) {
      _tools.UtilTools.error('vxe.error.errConflicts', ['tree-config', 'stripe']);
